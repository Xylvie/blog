@foreach ($posts as $post)
    <div class="w-full h-auto mx-auto mt-10 bg-blue-200 border rounded-md shadow-lg shadow-black">
        ...
        <div class="flex flex-col gap-10 px-5 py-2">
            <p class="w-full h-12">{{ $post->excerpt }}</p>
